...
const nextConfig:NextConfig={output:"standalone",poweredByHeader:false,compress:true,experimental:{serverActions:{bodySizeLimit:"55mb"}},images:{formats:["image/avif","image/webp"],qualities:[75,78,82,90],minimumCacheTTL:86400,deviceSizes:[360,640,768,1024,1280,1536],imageSizes:[32,48,64,96,128,256,384]},async headers(){return[{source:"/(.*)",headers:securityHeaders}]}};
