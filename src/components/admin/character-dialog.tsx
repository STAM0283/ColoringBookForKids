        ...
        <div className="grid items-start gap-5 lg:grid-cols-[minmax(0,1fr)_260px]">
          <div id="character-panel" role="tabpanel" aria-labelledby={`character-tab-${tab}`} className="min-w-0 space-y-4">
            {tab === "identity" ? <>
              ...
              <MarkdownEditor label="Devise" value={value.motto} onChange={motto => setValue({ ...value, motto })} maximumLength={180} minimumLength={0} required={false} compact help="Sa petite phrase préférée, avec gras ou italique si nécessaire."/>
