...
function normalizePlaybackRate(event:React.SyntheticEvent<HTMLVideoElement>){event.currentTarget.defaultPlaybackRate=1;event.currentTarget.playbackRate=1}
