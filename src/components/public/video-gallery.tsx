...
<MarkdownContent value={item.description} className="border-t pt-4 text-sm leading-relaxed text-foreground/60"/>
</div></div></div>
        </article>;
        })}
    </div>
...
<MarkdownContent value={selected.description} className="mt-3 leading-relaxed text-foreground/60"/>
</div></div></div>}
  </>;
}
